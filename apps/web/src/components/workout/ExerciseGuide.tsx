...
export function ExerciseGuide({
    ...
    return (
        ...
        >
            {/* GIF Display Area */}
            <div className={`relative aspect-square overflow-hidden bg-gradient-to-br ${muscleGradient}`}>
                {hasGif ? (
                    <>
                        <img
                            src={gifUrl}
                        ...
                        />
                        {/* Overlay badge */}
                        <div className="absolute top-3 right-3 bg-blue-500/90 backdrop-blur-sm rounded-full p-2">
